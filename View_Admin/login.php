<?php
    ...
    if($_SERVER['REQUEST_METHOD']=='POST')
	{
		if( isset($_POST["email"]) && isset($_POST["password"]))
		{
            ...
            $ad->setPass($_POST["password"]);
            if(!($auth->find_email($_POST["email"],$_POST["password"])))
            {
                echo "Sorry This Acount Is Not Valid, You Can Try Again";
                // $r='login.php';
            }
			...
			<section style="margin-top: 7%; margin-left: 35%;">
				...
				<div class="heading_container">
					<h1 class="" style="color: #e99c2e; font-size: 50px; margin-left:  2%;">
						<b><span style="color: #454240;">Log</span>in</b>
					</h1>
				</div>
				...
				<div class="row">
					...
					<form action="login.php" method="POST">
						...
						<div class="d-flex " style="margin-top: 5%; width: 60%; ">
						...
						<!-- <div class="d-flex " style="margin-top: 5%; width: 60%; ">
							<button class="btn-cart welcome-add-cart welcome-more-info"onclick="window.location.href='../View_User/Main.php'"
							 style="margin-left: 23%; margin-top: -6%; margin-bottom: 3%; background-color: #02010075; border-radius: 5px;" >
								Login As Guest
							</button>
						</div> -->
					</form>
